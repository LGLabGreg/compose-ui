...
export const metadata = {
  title: 'Accessibility',
  description: 'Accessibility built-in—ARIA attributes, keyboard navigation, and focus management work automatically.',
}
...
Compose UI components include comprehensive accessibility support:
...
While Compose UI handles the behavioral aspects, there are still things you should be mindful of:
